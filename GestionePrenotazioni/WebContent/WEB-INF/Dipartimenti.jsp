...
<%@ page import="Model.Dipartimento" import="java.util.ArrayList"%>
			...
			<table class="table table-hover">
				<thead onclick="getDipartimenti('<%= str %>')">
					<tr>
						...
						<th>Amministratore: <% for(Model.Dipartimento d: listaAmministratori) {
									if (d.getDip().equals(str)) {%> <%= d.getAmmDip() %> <% } %> <% } %>
						</th>
					</tr>
				</thead>
				<tbody id="<%= str %>"></tbody>
