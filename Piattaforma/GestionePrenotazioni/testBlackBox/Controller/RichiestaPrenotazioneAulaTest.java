...
import Model.Utente;
class RichiestaPrenotazioneAulaTest extends Mockito {
	...
	@Test
	void testCase_3_1_01() throws ServletException, IOException {
	...
	@Test
	void testCase_3_1_02() throws ServletException, IOException {
	...
	@Test
	void testCase_3_1_03() throws ServletException, IOException {
	...
	@Test
	void testCase_3_1_04() throws ServletException, IOException {
		doReturn("F2").when(request).getParameter("edificio");
		doReturn("F1").when(request).getParameter("aula");
		doReturn(null).when(request).getParameter("titolo");
		doReturn(requestDispatcher).when(request).getRequestDispatcher(any());
		doReturn(session).when(request).getSession();
		doReturn(new Utente("martina", "boriello", "martina.borriello@studenti.unisa.it", "12345678", 0)).when(session).getAttribute("utente");
		servlet.doPost(request, response);
		verify(request).setAttribute(any(), ac.capture());
	...
	@Test
	void testCase_3_1_05() throws ServletException, IOException {
		doReturn("F2").when(request).getParameter("edificio");
		doReturn("F1").when(request).getParameter("aula");
	...
	@Test
	void testCase_3_1_06() throws ServletException, IOException {
		doReturn("F2").when(request).getParameter("edificio");
		doReturn("F1").when(request).getParameter("aula");
	...
	@Test
	void testCase_3_1_07() throws ServletException, IOException {
		doReturn("F2").when(request).getParameter("edificio");
		doReturn("F1").when(request).getParameter("aula");
		doReturn("Tutorato").when(request).getParameter("titolo");
	...
	@Test
	void testCase_3_1_08() throws ServletException, IOException {
		doReturn("F2").when(request).getParameter("edificio");
		doReturn("F1").when(request).getParameter("aula");
		doReturn("Tutorato").when(request).getParameter("titolo");
		doReturn("descrizione tutorato").when(request).getParameter("descrizione");
	...
	@Test
	void testCase_3_1_09() throws ServletException, IOException {
		doReturn("F2").when(request).getParameter("edificio");
		doReturn("F1").when(request).getParameter("aula");
		doReturn("Tutorato").when(request).getParameter("titolo");
		doReturn("descrizione tutorato").when(request).getParameter("descrizione");
	...
	@Test
	void testCase_3_1_10() throws ServletException, IOException {
		doReturn("F2").when(request).getParameter("edificio");
		doReturn("F1").when(request).getParameter("aula");
		doReturn("Tutorato").when(request).getParameter("titolo");
		doReturn("descrizione tutorato").when(request).getParameter("descrizione");
	...
	@Test
	void testCase_3_1_11() throws ServletException, IOException {
		doReturn("F2").when(request).getParameter("edificio");
		doReturn("F1").when(request).getParameter("aula");
		doReturn("Tutorato").when(request).getParameter("titolo");
		doReturn("descrizione tutorato").when(request).getParameter("descrizione");
	...
	@Test
	void testCase_3_1_12() throws ServletException, IOException {
		doReturn("F2").when(request).getParameter("edificio");
		doReturn("F1").when(request).getParameter("aula");
		doReturn("Tutorato").when(request).getParameter("titolo");
		doReturn("descrizione tutorato").when(request).getParameter("descrizione");
	...
	@Test
	void testCase_3_1_13() throws ServletException, IOException {
		doReturn("F2").when(request).getParameter("edificio");
		doReturn("F1").when(request).getParameter("aula");
		doReturn("Tutorato").when(request).getParameter("titolo");
		doReturn("descrizione tutorato").when(request).getParameter("descrizione");
		...
		servlet.doPost(request, response);
		verify(request).setAttribute(any(), ac.capture());
		assertEquals("Richiesta effettuata" , ac.getValue());
	}
}
